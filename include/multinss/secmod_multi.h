...
#ifndef MULTINSS_SECMOD_MULTI_H
#define MULTINSS_SECMOD_MULTI_H

namespace multinss {

SECMODModule *SECMOD_GetInternalModule(const DBContext &context);

}

#endif //MULTINSS_SECMOD_MULTI_H
